...
<a href="/book/public/index.php/login" class="bk_bottom_tips bk_important">已有帐号? 去登录</a>
@endsection
...
<script type="text/javascript">
  ...
  $('.bk_validate_code').click(function () {
    $(this).attr('src', '/book/public/index.php/service/validate/create?random=' + Math.random());
  });
...
<script type="text/javascript">
  ...
  $('.bk_phone_code_send').click(function(event) {
    ...
    $.ajax({
      url: '/book/public/index.php/service/validate_phone/send',
      dataType: 'json',
      cache: false,
      data: {phone: phone},
  ...
  function onRegisterClick() {
    ...
    $('input:radio[name=register_type]').each(function(index, el) {
      if($(this).attr('checked') == 'checked') {
        ...
        $.ajax({
          type: "POST",
          url: '/book/public/index.php/service/register',
          dataType: 'json',
          cache: false,
