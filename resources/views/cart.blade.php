...
//控制每一个栏目的选择： 是否选中的动态设置
  ...
  function _toCharge() {
    ...
    location.href = '/book/public/index.php/order_commit?product_ids=' + product_ids_arr + '&is_wx=' + is_wx;
  ...
  function _onDelete() {
    ...
    $.ajax({
      type: "GET",
      url: '/book/public/index.php/service/cart/delete',
      dataType: 'json',
      cache: false,
      data: {product_ids: product_ids_arr+''},   //数组加上 ''  ，会自动变成以逗号分隔的字符串
